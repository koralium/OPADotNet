...
extern __declspec(dllexport) void Evaluate(GoInt compilerId, char* query, char* input, evaluate_cb callback);
extern __declspec(dllexport) void Partial(GoInt compilerId, char* query, char* input, evaluate_cb callback);
...
extern __declspec(dllexport) void WriteToStore(int storeId, int transactionId, char* path, char* input);
extern __declspec(dllexport) int NewTransaction(int storeId);
...
extern __declspec(dllexport) GoInt UpsertPolicy(int storeId, int transactionId, char* policyName, char* module, error_cb callback);
