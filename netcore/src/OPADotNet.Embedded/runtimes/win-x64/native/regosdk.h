...
extern __declspec(dllexport) int PreparedPartial(GoInt partialId, char* input, char** unknowns, int unknownsLength, char trace);
extern __declspec(dllexport) int FullPartial(GoInt compilerId, GoInt storeId, char* query, char** unknowns, int unknownsLength);
